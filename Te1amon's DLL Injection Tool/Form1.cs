...
namespace Te1amon_s_DLL_Injection_Tool
{
    public partial class Form1 : Form
    {
        ...
        string dllpathfunny = Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location) + @"/AlexextaWall.dll";
        ...
        public DllInjectionResult Injectmabob(string sProcName, string sDllPath)
        {
            ...
            else
            {
                ...
                {
                    bool flag2 = !(processes[i].ProcessName != "hl");
                    if (flag2)
                    {
